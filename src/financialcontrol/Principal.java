...
//	Menu de ações
	public static void main(String[] args) {
		...
		if(opcao == 1)
			...
			for (Movimentacao element : movimento) {
				System.out.printf("\nTipo: "+element.getTipoDeMovimentacao()+
						"    Observação: "+element.getObservacaoDaMovimentacao()+
						"    Valor: "+element.getValorDaMovimentacao()+
						"    Data: "+element.getDataDaMovimentacao());
		}
	}
}
